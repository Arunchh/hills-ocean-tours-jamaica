...
export const uiEn: UiMessages = {
  ...
  sections: {
    ...
    testimonials: {
      ...
      title: "Real Comments from Our Instagram",
      description:
        "Every quote below is a genuine comment left by travelers on our @hillsoceansja posts and reels — not marketing copy written for this website.",
      instagramNote:
        "Likes and view counts are shown where available. Tap any card to open the original Instagram post.",
      instagramSource: "Genuine Instagram comment",
      instagramComment: "Instagram comment",
      viewOnInstagram: "View original post on Instagram",
    },
    faq: {
      eyebrow: "FAQ",
  ...
  booking: {
    ...
    description:
      "Pick an open slot below. We hold your request instantly — confirm details and pay your 50% deposit on WhatsApp (CashApp or Zelle).",
    loading: "Loading availability…",
    fallbackTitle: "Message us to book",
    fallbackDescription:
      "Online scheduling is not set up for this tour yet. WhatsApp us with your hotel, date, and group size.",
    prevMonth: "Previous month",
    nextMonth: "Next month",
    dateClosed: "Closed",
    dateFull: "Fully booked",
    timeSlots: "Available start times",
    duration: "Duration",
    noSlots: "No times available on this date. Try another day or message us on WhatsApp.",
    timezone: "All times are Jamaica time (America/Jamaica).",
    selectDateHint: "Select a date on the calendar to see available start times.",
    fullName: "Full name",
    phone: "Phone / WhatsApp",
    email: "Email (optional)",
    resort: "Hotel / resort",
    resortPlaceholder: "e.g. Hyatt Zilara Rose Hall",
    guests: "Number of guests",
    notes: "Notes (optional)",
    submit: "Request booking & open WhatsApp",
    submitting: "Saving your request…",
    success: "Request saved! WhatsApp should open — send the message so we can confirm your booking.",
    error: "Could not save that slot. It may have just been taken — pick another time or WhatsApp us.",
    disclaimer:
      "No online payment. A 50% deposit via CashApp or Zelle confirms your booking after we reply on WhatsApp.",
    whatsappTemplate:
      "Hi {business}, I'd like to book:\n\nTour: {tour}\nDate: {date}\nStart time: {time} (Jamaica time)\nDuration: {duration}\nHotel: {resort}\nGuests: {guests}\nName: {name}\nPhone: {phone}\nReference: {reference}\n\nPlease confirm availability and deposit details.",
    pageTitle: "Book {tour}",
    pageDescription: "Select a date and time for {tour}. Confirm on WhatsApp — 50% deposit via CashApp or Zelle.",
    ...
    selectTimeHint: "Choose a start time to continue with your details.",
    openWhatsAppAgain: "Open WhatsApp again",
    bookNow: "Book this tour",
    depositReminder: "50% deposit via CashApp or Zelle after we confirm on WhatsApp. No payment on this website.",
